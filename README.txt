...
Misc
  ...
  File                                Description
  ----------------------------------- -----------------------------------
  yt-dlp.tar.gz                       Source tarball. Also contains
                                      manpages, completions, etc
...
5.  Replacement: A replacement value can specified using a & separator.
    If the field is not empty, this replacement value will be used
...
-   innertube_host: Innertube API host to use for all API requests
    ...
    -   Note: Cookies exported from www.youtube.com will not work with
        hosts other than *.youtube.com
