...
class VoeIE(SeleniumInfoExtractor):
    ...
    def _get_entry(self, url, **kwargs):
        ...
        try:
            ...
            if not sources: raise ExtractorError(f"{pre} no video sources")
            ...
            if 'hls' in sources:
                ...
                if fmts: _formats.extend(fmts)
            
            if not _formats: raise ExtractorError(f"{pre} No formats found")
